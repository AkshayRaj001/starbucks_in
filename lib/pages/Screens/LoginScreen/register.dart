...
import 'package:starbucks_in/compoents/circles.dart';
import 'package:starbucks_in/compoents/text1.dart';
import 'package:starbucks_in/pages/Screens/LoginScreen/homeScreen.dart';
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (text) {
                      setState(() {
                        ...
                        //   isEmailvalid = true;
                        //   isPhonevalid = false;
                        // }else if(text.length == 10 && int.tryParse(text) != null){
                        //   isEmailvalid = false;
                        //   isPhonevalid = true;
                        // }else{
                        //   isEmailvalid = false;
